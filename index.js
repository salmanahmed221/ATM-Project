...
if (Userid && Pin && Cashamount) {
    console.log(chalk.bgWhiteBright(`Your remaining balance is ${Balance - Cashamount}`));
}
if (Userid && Pin && WithdrawCash < Balance) {
    console.log(chalk.bgWhiteBright(`You have Withdraw ${WithdrawCash} & Your remaining balance is ${Balance - WithdrawCash}`));
}
